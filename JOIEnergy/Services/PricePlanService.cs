...
namespace JOIEnergy.Services
{
    public class PricePlanService : IPricePlanService
    {
        ...
        public Dictionary<String, decimal> GetPeriodConsumptionCostOfElectricityReadingsForEachPricePlan(String smartMeterId)
        {
            List<ElectricityReading> electricityReadings = _meterReadingService.GetLastWeekReading(smartMeterId);
